...
def parse_arguments_for_MASAC():
    ...
    parser.add_argument('--sumocfg_path', type=str, help='sumocfg文件路径', default= "/home/weizhiwei/data/FL_DRL_Edge/sumo_berlin/map.sumocfg")
    parser.add_argument('--osm_path', type=str, help='osm文件路径', default= "/home/weizhiwei/data/FL_DRL_Edge/sumo_berlin/map.osm")
    parser.add_argument('--net_path', type=str, help='net文件路径', default= "/home/weizhiwei/data/FL_DRL_Edge/sumo_berlin/map.net.xml")
    parser.add_argument('--tensorboard_writer_file', type=str, help='tensorboard_writer_file', default= f"/home/weizhiwei/data/FL_DRL_Edge/runs3/{method}")
    parser.add_argument('--saved_path', type=str, help='saved_path', default= f"/home/weizhiwei/data/FL_DRL_Edge/models/{method}_models")
    # uav_path_file
    parser.add_argument('--UAV_path_file', type=str, help='UAV_path_file', default= f"/home/weizhiwei/data/FL_DRL_Edge/dataset/uav_trace_dataset_results.pkl")
