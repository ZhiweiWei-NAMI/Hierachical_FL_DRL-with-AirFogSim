...
methods = ['MAPPO_AggFed_cluster3_local_max12nRBselffree', 'MAPPO_AggFed_cluster2_local_max12nRBselffree', 'MAPPO_AggFed_cluster1_local_max12nRBselffree']
name=['AFedPPO-CCP, n_cluster=3', 'AFedPPO-CCP, n_cluster=2', 'AFedPPO-CCP, n_cluster=1']
...
plt.savefig('../latex/png/reward_curve_cluster.png',dpi=300,bbox_inches='tight')
plt.show()
