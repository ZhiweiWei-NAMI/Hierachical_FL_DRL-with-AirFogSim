...
methods = ['MAPPO_AggFed_cluster2_local_max12nRBselffree','MAPPO_AggFed_cluster2_max12nRBselffree','Certain_FedAvg_max12nRBselffree','MAPPO_nFL_max12nRBselffree','MAPPO_Cen_max12nRBselffree','greedy_notLearn_max12nRBselffree']
# methods = ['MAPPO_AggFed_cluster2_local_max12nRBselffree','MAPPO_AggFed_cluster1_local_max12nRBselffree','MAPPO_Cen_nMA_max12nRBselffree','MAPPO_AggFed_cluster2_max12nRBselffree']
name=['AFedPPO-CCP, Ours', 'AFedPPO-C','AFedPPO-Avg','AFedPPO-only','Cen-PPO','Greedy']
...
for i, method in enumerate(methods):
    ...
    # 把reward进行平滑，要求对每个episode进行平滑，即[0,9000],[9000,18000],[18000,27000],[27000,36000]
...
plt.ylabel('Reward (Task Utility)')
plt.title(f'Reward Curve (Smoothed Window={window_size}) for 4 Deployments')
# x轴范围
plt.xlim(0, max_step)
# x轴 3000, 6000, ..., 36000
...
plt.savefig('../latex/png/reward_curve.png',dpi=300,bbox_inches='tight')
plt.show()
